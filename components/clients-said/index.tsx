...
const ClientsSaid = () => {
    ...
    return (
        <>
            <div className=' w-[65%] p-4 max-lg:w-[auto]'>
                <div className=' flex flex-col justify-center items-center py-4 px-2'>
                    ...
                    <h1 className='text-[#fff] text-[50px] font-bold leading-none pt-5'>What Clients Said</h1>
                    <p className='text-[#999999] text-[16px] font-normal py-2 text-center '>Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore <br /> et dolore magna aliqua Ut enim ad voluptate velit esse cillum dolore eu fugiat.</p>
